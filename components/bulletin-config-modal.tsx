...
export function BulletinConfigModal({
  ...
  const autoGenerateAllContent = async () => {
    ...
    try {
      ...
      // Generate greeting message if previous greeting is available
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    onChange={(e) => onConfigChange('tableOfContents', e.target.checked)}
                    className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                  />
                </div>
                
                <div className="flex items-center justify-between">
                  <label className="text-sm font-medium">5 Key Trends</label>
                  <input
                    type="checkbox"
                    checked={config.keyTrends}
                    onChange={(e) => onConfigChange('keyTrends', e.target.checked)}
                    className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    type="checkbox"
                    checked={config.executiveSummary}
                    onChange={(e) => onConfigChange('executiveSummary', e.target.checked)}
                    className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <input
                    type="checkbox"
                    checked={config.keyTakeaways}
                    onChange={(e) => onConfigChange('keyTakeaways', e.target.checked)}
                    className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <input
                    type="checkbox"
                    checked={config.interactiveMap}
                    onChange={(e) => onConfigChange('interactiveMap', e.target.checked)}
                    className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                  />
                </div>
                
                <div className="flex items-center justify-between">
                  <label className="text-sm font-medium">Calendar Section</label>
                  <input
                    type="checkbox"
                    checked={config.calendarSection}
                    onChange={(e) => onConfigChange('calendarSection', e.target.checked)}
                    className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                  />
                </div>
              </div>
