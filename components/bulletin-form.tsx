  ...
  return (
    <div className="container mx-auto p-8 max-w-4xl">
      <div className="bg-white rounded-lg shadow-md p-8">
        <h2 className="text-3xl font-bold text-center mb-2">Sustainability Bulletin Generator</h2>
        <p className="text-gray-600 text-center mb-8">
          Create customized sustainability news bulletins with global coverage
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Search for sustainability topics, regulations, or companies..."
